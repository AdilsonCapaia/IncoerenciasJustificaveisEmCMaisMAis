...
```
Dai a obrigatoriadade de utilizar o asterisco **( * )** para modificar ou recuperar o valor da variavel na qual o ponteiro aponta *( *p )*, e utilizar o nome do ponteiro sozinho para afectar-lhe o endereço de uma variável *( *pi = &numero)*. Voilà.
